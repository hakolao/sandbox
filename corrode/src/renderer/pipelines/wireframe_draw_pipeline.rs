...
pub struct WireframeDrawPipeline {
    gfx_queue: Arc<Queue>,
    pipeline: Arc<GraphicsPipeline>,
}

impl WireframeDrawPipeline {
    pub fn new(gfx_queue: Arc<Queue>, subpass: Subpass) -> Result<WireframeDrawPipeline> {
        let pipeline = {
